...
def draw_controls():
    ...
    Button(control_surface, 110, 40, 80, 40, text=text, fontSize=16, inactiveColour=YELLOW, pressedColour=GRAY, onClick=play_or_pause)

    Button(control_surface, 210, 40, 80, 40, text='Reset', fontSize=16, inactiveColour=YELLOW, pressedColour=GRAY, onClick=reset_grid)

    Button(control_surface, 310, 40, 80, 40, text='Save', fontSize=16, inactiveColour=YELLOW, pressedColour=GRAY, onClick=save_grid)

    Button(control_surface, 410, 40, 80, 40, text='Load', fontSize=16, inactiveColour=YELLOW, pressedColour=GRAY, onClick=load_grid)

    Button(control_surface, 510, 40, 40, 40, text='+', fontSize=16, inactiveColour=YELLOW, pressedColour=GRAY, onClick=lambda: change_speed(1))

    Button(control_surface, 570, 40, 40, 40, text='-', fontSize=16, inactiveColour=YELLOW, pressedColour=GRAY, onClick=lambda: change_speed(-1))
